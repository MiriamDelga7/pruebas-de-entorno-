...
case "$1" in
    activar) activar_dns ;;
    revision) ver_estado ;;
    crear) crear_zona $2 $3 ;;
    mostrar) mostrar_zonas ;;
    borrar) borrar_zona $2 ;;
    remover) remover_dns ;;
    *)
        echo "Comandos disponibles:"
        echo "./dnsM.sh activar"
        echo "./dnsM.sh revision"
        echo "./dnsM.sh crear dominio.com IP"
        echo "./dnsM.sh mostrar"
        echo "./dnsM.sh borrar dominio.com"
        echo "./dnsM.sh remover"
    ;;
esac
